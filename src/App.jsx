...
/*
	...
	- App.jsx에서의 개발 흐름
		...
		4. (중요***) media query로 작업하지 않은 이유: module sass는 아니지만 컴포넌트의 효율적인 유지보수를 위해서 폴더별로 jsx와 scss파일을 그룹화하다보니 일반 미디어쿼리로 반응형처리하기에는 반복작업과 css변수 활용에 어려움이 있어서 useMedia custom hook을 직접 만들어서 스크립트로 반응형 처리할 수 있게 구현 (--> useMedia hook 가이드 문서 p.100)
